...
interface PublicVehicleDetailsProps {
  vehicle: Vehicle;
  onClose: () => void;
}

const PublicVehicleDetails: React.FC<PublicVehicleDetailsProps> = ({ vehicle, onClose }) => {
                  ...
                  <div className="flex flex-col sm:flex-row gap-6 relative z-10 items-start">
                    ...
                    <div className="flex-1 min-w-0">
                       ...
                       <div className="grid grid-cols-2 lg:grid-cols-3 gap-2">
                          {Object.values(grade.categories).map((cat:any, i) => (
