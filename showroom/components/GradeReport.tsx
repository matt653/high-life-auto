...
import { Vehicle, GradeResult, ReportCategory } from '../types';
...
const CategoryRow: React.FC<{ category: ReportCategory; icon: React.ReactNode }> = ({ category, icon }) => {
...
const GradeReport: React.FC<GradeReportProps> = ({ vehicle, grade, onClose }) => {
  return (
