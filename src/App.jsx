...
function App() {
  ...
  const isRearend = hostname.startsWith('rearend.');
  const isLabs = hostname.startsWith('labs.') || hostname.startsWith('lab.');
  // Hide public layout elements for admin tools
  const isPublicLayout = !isRearend;
          ...
          <div className="app">
            ...
            <main>
              <Suspense fallback={<PageLoader />}>
                <Routes>
                  <Route path="/" element={
                    isRearend ? <InventoryManager /> :
                      isLabs ? <AIToolsDashboard /> :
                        <Homepage />
                  } />
